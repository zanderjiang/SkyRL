...
def build_vllm_cli_args(cfg: SkyRLTrainConfig) -> Namespace:
    ...
    overrides = dict(
        ...
        # Parity with the legacy engine path (which hardcodes this): models with custom modeling
        # code (MiMo, Qwen3.5, DeepSeek-V3, ...) require it to load at all. Overridable via
        # generator.inference_engine.engine_init_kwargs.trust_remote_code below.
